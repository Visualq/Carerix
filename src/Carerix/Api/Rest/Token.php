...
class Carerix_Api_Rest_Token {
     ...
     * @param Carerix_Api_Rest_Manager $manager [optional] allows you to configure HTTP client w/ custom options: endpoint, proxy, etc.
     * @return string application token
     * @throws Carerix_Api_Rest_Exception
     */
    public static function get($params = array(), Carerix_Api_Rest_Manager $manager = null) {
